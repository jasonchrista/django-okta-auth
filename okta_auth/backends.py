...
from .utils import get_email_from_token, get_login_url, get_logout_url, is_email_verified_from_token
...
class OktaBackend(object):
    USER_CREATION = getattr(settings, "OKTA_USER_CREATION", True)
